...
export class CheckoutComponent implements OnInit {
  ...
  pay(): void {
    ...
    // ABA PayWay: redirect the browser to ABA's hosted checkout page. On success
    // ABA returns to /payment/return, which verifies and marks the booking paid.
    if (this.selectedMethod() === 'ABA Pay') {
      this.paymentService.createPaywayForm(booking._id).subscribe({
