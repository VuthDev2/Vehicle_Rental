...
// Phone Verification
router.post('/send-otp', protect, verificationLimiter, verificationController.sendOtp);
router.post('/verify-otp', protect, verificationLimiter, verificationController.verifyOtp);
